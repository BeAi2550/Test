        ...
        while getgenv().JumpPowerBypass == true do
            pcall(function()
                if game.Players.LocalPlayer.Character:FindFirstChildOfClass("Humanoid"):GetState() == Enum.HumanoidStateType.Jumping then
                    game.Players.LocalPlayer.Character.Humanoid.RootPart.CFrame = game.Players.LocalPlayer.Character.Humanoid.RootPart.CFrame * CFrame.new(0,60,0);
                end
            end)
            task.wait(0.0015);
        end
...
getgenv().EspOnItems = function()
    ...
    local function ShouldIgnore(X)
        return X.Name == "SoulSpawn" "Box" or X.Position == Vector3.new(1804.5390625,-298.173583984375,-309.4649658203125);
    end
...
getgenv().UsingDekuAutofarm1 = function()
        ...
        while getgenv().AutofarmOnDeku1 == true do
            pcall(function()
                ...
                if not game:GetService("Workspace").Living:FindFirstChild("Deku") and not game:GetService("Workspace").Living:FindFirstChild("Roland") and not game:GetService("Workspace").Item2:FindFirstChild("OA's Grace") and Lplayer.Backpack:FindFirstChild("OA's Grace") and not Lplayer.PlayerGui.InCombat.Enabled and Lplayer.Data.StandName.Value == "Shinra Kusakabe" then
                    Lplayer.Character.HumanoidRootPart.CFrame = CFrame.new(-50.88117599487305,-116.3696060180664,344.53594970703125);
                    for i = 1, 100 do
                        if Lplayer.PlayerGui.StandStorage.Outer.Inner.Inner["Slot"..i].Text.Text == "One for All [Stage 3]" then
                            local args = {"Slot"..i};
                            if i <= 6 then
                                game:GetService("ReplicatedStorage").StorageRemote["Slot"..i]:FireServer();
                            else
    ...
    task.spawn(function()
        while getgenv().AutofarmOnDeku1 == true do
            pcall(function()
                local Lplayer = game:GetService("Players").LocalPlayer;
                if not game:GetService("Workspace").Living:FindFirstChild("Deku") and not game:GetService("Workspace").Living:FindFirstChild("Roland") and not game:GetService("Workspace").Item2:FindFirstChild("OA's Grace") and Lplayer.Backpack:FindFirstChild("OA's Grace") and Lplayer.Data.StandName.Value == "One for All [Stage 3]" then task.wait(0.12);
                    Lplayer.Character.HumanoidRootPart.CFrame = CFrame.new(-50.88117599487305,-116.3696060180664,344.53594970703125);
...
getgenv().UsingDekuAutofarm3 = function()
    ...
    task.spawn(function()
        while getgenv().AutofarmOnDeku3 == true do
            pcall(function()
                local Lplayer = game:GetService("Players").LocalPlayer;
                if Lplayer.PlayerGui.InCombat.Enabled and Lplayer.Data.StandName.Value == "Ond for all [Stage 3]" or Lplayer.PlayerGui.InCombat.Enabled and Lplayer.Data.StandName.Value == "Onr for All [Stage 4]" then
                    game.Players.LocalPlayer.Character.Humanoid.Health = 0;
                end
            end)
            task.wait(1.35);
...
AreasTab.newButton("Ruined City","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-7146.21923828125, -32.022640228271484, 1295.2347412109375);
    end)
end)
...
AreasTab.newButton("Testing Place","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1185.2999267578125, -75.57532501220703, -275.0804748535156);
    end)
end)
...
AreasTab.newButton("New Map","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-9300.7255859375, 820.3775634765625, 9504.0634765625);
    end)
end)

AreasTab.newButton("Red Mist Room","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-248.5664825439453, 46.86923599243164, -2889.913330078125);
    end)
end)
...
AreasTab.newButton("High View City","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-242.073974609375, 281.17010498046875, 1650.7857666015625);
    end)
end)
...
AreasTab.newButton("Wuthering Height","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-3023.88134765625, 4.000030517578125, -10567.544921875);
    end)
end)

AreasTab.newButton("Big Ruined City","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-62.55635070800781, 790.7645263671875, -7950.7353515625);
    end)
end)

AreasTab.newButton("Blue Lock","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(7097.5341796875, 207.64105224609375, 3034.987548828125);
    end)
end)

AreasTab.newButton("Void","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-948.0050048828125, 1011, 43.19108200073242);
    end)
end)

AreasTab.newButton("BruningHall","",function()
    pcall(function()
        getgenv().PlaySound();game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2602.805908203125, 631.9755249023438, -3355.756103515625);
    end)
end)
